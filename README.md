...
- `/plan draft <title>` / `/plan import <json>`: create or import a structured coding plan; `/plan`, `/tasks`, and `/packet` inspect the latest plan and local-worker task packet
